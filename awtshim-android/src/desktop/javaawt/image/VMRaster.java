...
public class VMRaster implements Raster
{
	...
	public VMRaster(java.awt.image.Raster delegate)
	{
	...
	public DataBuffer getDataBuffer()
	{
		if (delegate.getDataBuffer() instanceof DataBufferInt)
			return new VMDataBufferInt((DataBufferInt) delegate.getDataBuffer());
		else
			return new VMDataBufferByte((DataBufferByte) delegate.getDataBuffer());
	}
}
